...
export class AuthenticationService implements IAuthenticationService {
  ...
  public async getUser(): Promise<GetUserPayloadResult> {
    return await this.userManager.getUser();
  }

  public async login(returnPath: string): Promise<LoginPayloadResult> {
    try {
  ...
  public async signinRedirectCallback(returnPath: string): Promise<SignInRedirectCallbackPayloadResult> {
  ...
  public async signinSilentCallback(): Promise<SignInSilentCallbackPayloadResult> {
