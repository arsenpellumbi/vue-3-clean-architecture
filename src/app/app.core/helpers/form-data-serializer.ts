...
export class FormDataSerializer {
  ...
  static serialize = (object: any, config?: any, formData?: FormData, key?: string): FormData => {
    ...
    config.nullsAsUndefineds = FormDataSerializer.isUndefined(config.nullsAsUndefineds) ? false : config.nullsAsUndefineds;

    config.booleansAsIntegers = FormDataSerializer.isUndefined(config.booleansAsIntegers) ? false : config.booleansAsIntegers;
    ...
    } else if (FormDataSerializer.isObject(object) && !FormDataSerializer.isFile(object) && !FormDataSerializer.isBlob(object)) {
