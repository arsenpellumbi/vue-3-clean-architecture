<template>
  <q-page class="q-pa-md items-center justify-evenly q-gutter-md">
    ...
    <task-form :value="createTaskForm" @update:value="(value) => (createTaskForm = value)" :project-id="project.id" />
    <task-form
      :value="editTaskForm"
      @update:value="(value) => (editTaskForm = value)"
...
<script src="./project-item"></script>
